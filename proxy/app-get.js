...
/**
 * @name 罗婵
 * @Date 2022-01-19 09:33:10
 * @introduction get请求的代理
 * @description
 * @param {object} params 请求中解析后的的query
 * @param {string} params.host 需要转发请求的host
 * @param {string} params.path 需要转发请求的路径
 * @param {string} params.loginPath 需要转发请求的登录接口路径
 * @param {string} params.loginContent 登录的账密JSON.stringify
 * @return {*}
 * @exception
 */
...
console.log(chalk.green(`[OUTPUT] Server: listening on port ${PORT}`));
console.log(chalk.green(`[OUTPUT] Opening: http://localhost:${PORT}`));
